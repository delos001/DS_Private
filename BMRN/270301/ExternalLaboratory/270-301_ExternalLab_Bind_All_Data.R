...
# write.csv(LabBindAll_NoResults, file.path(outloc_bindall, 'LabBindAll_Results.csv'), 
#                                     row.names = FALSE)
# 
# write.csv(LabBindAll_NoResults, file.path(outloc_bindall, 'LabBindAll_NoResults.csv'), 
#                                       row.names = FALSE)
