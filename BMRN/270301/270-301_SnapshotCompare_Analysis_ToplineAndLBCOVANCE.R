...
sctl_filedate1 = '20210201'   ## <------------------enter file date here YYYYMMDD
sctl_ext1 = '.xlsx'
...
scfiledate1 = '20210201'   ## <------------------enter file date here YYYYMMDD
scext1 = '.xlsx'
...
tlAndLBCOVNACE_bind = bind_rows(aesnapjoin, cmsnapjoin, lbcovancesnapjoin, 
